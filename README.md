...
**To ensure the accuracy of the underlying data, the skill libraries were generated through a multi-step pipeline:**

 - **Initial Extraction:** OpenCV was utilized to process the official Code of Points (CoP) PDF documents, identifying and extracting skill tables into a structured format.
 - **JSON Conversion:** The raw extracted data was converted into event-specific JSON files used by the application.
   
 - **Manual Validation:** All automated output underwent manual verification to ensure skill values, groups, and descriptions align with current technical regulations.

### Disclaimer

This project is intended for **educational and research purposes only**. The data provided within the skill libraries was extracted for the purpose of demonstrating technical automation and routine-building logic. 

*   **Accuracy**: While every effort has been made to ensure data integrity, this tool should not be used as the sole authority for official competition scoring. Always refer to the most recent FIG and USAG publications for final rule interpretations.
*   **Intellectual Property**: All gymnastics skill descriptions and values are the property of the International Gymnastics Federation (FIG) and respective national governing bodies. This project is not affiliated with, endorsed by, or sponsored by the FIG or USAG.
*   **Fair Use**: Use of the technical materials within this repository is intended to fall under "fair use" for non-commercial, educational development.
